...
v8::Handle<v8::Value> callbackWithResult(v8::HandleScope &scope,const v8::Local<v8::Function> &cb,const std::shared_ptr<nj::Result> &res,const v8::Handle<v8::Object> &recv);
